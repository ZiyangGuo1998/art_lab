...
function Hero() {
  return (
    <header
      id="top"
      className="grid min-h-[96vh] items-end px-[clamp(1rem,4vw,4rem)] pb-[2.2rem] pt-28 text-[var(--white)] max-[980px]:bg-[35%_center] max-[640px]:min-h-[94vh] max-[640px]:pt-36"
      style={{
        backgroundImage:
